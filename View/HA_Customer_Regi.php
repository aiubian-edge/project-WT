...
<td colspan="2" > <section align='right'>  <a href=../Home.php> <img src="../Image/Capturcsdfcsde.JPG" width="180" height="080" align ="left"/></a>
 ...
 📊Hotel System Admin Dashboard📊<br></h1>
      ...
      <td align="center">
       ...
       <tr>
          <td>
              <h3 align="center"> Customer Status!
              <br>CheckIn?
       <input type="radio" name="status" id="status" value="CheckIn" placeholder="" checked> Yes
       <input type="radio" name="status" id="status"  value="CheckOut" placeholder=""> No </h3>
           </td>
           <td  align="center" colspan="2">
              <input  type="submit" name="CusR" value="Allotment" style="color:#00ccff;font-size:50px;"  width="250px">
           </td>
       </tr>
			...
			<table border="0" width="100%">
               ...
               <th>
                ...
                <td align="center"><?=$cuss[$i]['status']?></td>
					...
					<td>
					<form method="GET" action="../Controller/CusRegiUpdate.php">
                           <input type="button" name="cname" value="<?= $cuss[$i]['cname']?>" hidden >
				        <input  type="submit" name="sub" value="Edit Room" placeholder="" >
						</form>
						
						 
						<!--<form method="GET" action="../View/deleteRoom.php">
                           <input type="button" name="roomNo" value="<?= $cuss[$i]['roomNo']?>" hidden >
				        <input  type="submit" name="sub" value="Delete Room" placeholder="" >
						</form> -->
					</td>
				</tr>
